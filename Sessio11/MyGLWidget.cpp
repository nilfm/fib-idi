...
void MyGLWidget::initializeGL ()
{
  ...
  posFocus2 = glm::vec3(0, -0.5, 0);
  focusDX = 0.0;  // en SCA
  intensity = 1;

  focus2mov = glm::vec3(0, 0, 0);
  TG = View = Proj = glm::mat4(1.0);
}
...
//  glViewport (0, 0, ample, alt);
  ...
  glm::vec3 posF = posFocus + glm::vec3(focusDX, 0.0, 0.0);
  if (mode) posF = glm::vec3(View*glm::vec4(posF, 1.0));
  glUniform3fv(posFLoc, 1, &posF[0]);
  glm::vec3 temp = posFocus2+focus2mov;
  glm::vec3 posF2 = glm::vec3(View*glm::vec4(temp, 1.0));
  glUniform3fv(posF2Loc, 1, &posF2[0]);
  ...
  glUniform1i(intensityLoc, intensity);
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::translate(TG, focus2mov);
  TG = glm::translate(TG, glm::vec3(0, -0.85, 0));
...
{
  Proj = glm::mat4(1.0);  // Matriu de projecció
  if (perspectiva)
...
{
  View = glm::mat4(1.0);  // Matriu de posició i orientació
...
void MyGLWidget::carregaShaders()
{
  ...
  intensityLoc = glGetUniformLocation (program->programId(), "intensity");
}
